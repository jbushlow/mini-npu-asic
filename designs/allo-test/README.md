...
This makes the example legal for HLS dataflow while remaining representative
...
The default graph targets Catapult HLS C synthesis, normalizes the generated RTL,
