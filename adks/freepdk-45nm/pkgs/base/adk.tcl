...
#-------------------------------------------------------------------------
# ADK_HOLD_FIXING_CELL_LIST (OPTIONAL)
#-------------------------------------------------------------------------
# This list is intentionally separate from ADK_BUF_CELL_LIST. Hold repair
# should prefer small, slower buffers that add useful delay without using
# clock buffers or unnecessarily large drive-strength cells.

set ADK_HOLD_FIXING_CELL_LIST \
  "BUF_X1 \
   BUF_X2"
